...
| Rust workspace tests (I1 runtime + gates + ACS + bridge) | Behaviour, Formal | L2 | G0 | PASS | 78 tests passed | `cargo test --manifest-path runtime/Cargo.toml --workspace` | <!-- probe:rust-workspace -->
